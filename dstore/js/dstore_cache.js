...
var charset="unknown";
	...
	for(var i=1;i<aa.length;i++)
	{
		...
		acts.push("<iati-activity xmlns:dstore=\"http://d-portal.org/xmlns/dstore\" dstore:dataset=\""+xmlfilename+"\" dstore:index=\""+i+"\" "+v+"</iati-activity>"); // rebuild and add import filename
	}
